...
export default function MobileNav() {
  ...
  return (
    <nav aria-label="Primary" className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-[#1e1f32]/95 backdrop-blur-xl border-t border-[var(--color-border)] dark:border-[#2a2b3e] shadow-[0_-4px_20px_rgba(0,0,0,0.04)] dark:shadow-[0_-4px_20px_rgba(0,0,0,0.35)]">
